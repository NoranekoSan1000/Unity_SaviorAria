...
public class ScoreManager : MonoBehaviour
{
    ...
    public Text[] score_text2 = new Text[9]; // TextƒIƒuƒWƒFƒNƒg
    ...
    void Update()
    {
        ...
        score_text2[0].text = "1st: " + SaveName[0] + "y" + SaveRanking[0] + "z";
        score_text2[1].text = "2nd: " + SaveName[1] + "y" + SaveRanking[1] + "z";
        score_text2[2].text = "3rd: " + SaveName[2] + "y" + SaveRanking[2] + "z";
        score_text2[3].text = "4th: " + SaveName[3] + "y" + SaveRanking[3] + "z";
        score_text2[4].text = "5th: " + SaveName[4] + "y" + SaveRanking[4] + "z";
        score_text2[5].text = "6th: " + SaveName[5] + "y" + SaveRanking[5] + "z";
        score_text2[6].text = "7th: " + SaveName[6] + "y" + SaveRanking[6] + "z";
        score_text2[7].text = "8th: " + SaveName[7] + "y" + SaveRanking[7] + "z";
        score_text2[8].text = "9th: " + SaveName[8] + "y" + SaveRanking[8] + "z";
